...
conn = mysql.connector.connect(user='root', password='Ragava.123', host='127.0.0.1', database="phonepe_pulse")
...
if SELECT == "Home":
    ...
    col1.image(Image.open("C:\\Users\\Parthiban V\\OneDrive\\Desktop\\Phonepe_image2.png"), width=500)
    with col1:
        st.subheader(
    ...
    with col2:
        st.video("C:\\Users\\Parthiban V\\OneDrive\\Desktop\\upi.mp4")
...
if SELECT == "Explore Data":
    ...
    if Type == "Transactions":
        ...
        with col1:
            ...
            df2 = pd.read_csv(r"C:\\Users\\Parthiban V\\OneDrive\\Desktop\\Statenames.csv")
            df2.State = df1
...
if SELECT == "About":
    col1, col2 = st.columns(2)
    with col1:
        st.video("C:\\Users\\Parthiban V\\OneDrive\\Desktop\\pulse-video.mp4")
    with col2:
        st.image(Image.open("C:\\Users\\Parthiban V\\OneDrive\\Desktop\\Phonepe_image2.png"), width=500)
        st.write("---")
    ...
    with col1:
        ...
        st.image(Image.open("C:\\Users\\Parthiban V\\Downloads\\about_phonepe.jpg"), width=400)
        with open("C:\\Users\\Parthiban V\\Downloads\\about_phonepe1.png", "rb") as f:
            data = f.read()
        st.download_button("DOWNLOAD REPORT", data, file_name="annual report.pdf")
    with col2:
        st.image(Image.open("C:\\Users\\Parthiban V\\Downloads\\about_phonepe1.png"), width=800)

# ----------------------Contact---------------#


if SELECT == "Contact":
    Name = (f'{"Name :"}  {"Parthiban V"}')
    mail = (f'{"Mail :"}  {"pvasudwvan@gmail.com"}')
